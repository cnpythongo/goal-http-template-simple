...
// Upload 根据引擎类型上传文件
func (sd *storageDriver) Upload(file *multipart.FileHeader, folder string) (uf *UploadFile, e error) {
...
// localUpload 本地上传
func (sd *storageDriver) localUpload(file *multipart.FileHeader, key string, folder string) (string, error) {
	// 保存根目录
...
// checkFile 文件验证
func (sd *storageDriver) checkFile(file *multipart.FileHeader) (e error) {
...
func (sd *storageDriver) RemoveFile(filePath string) (err error) {
...
func (sd *storageDriver) MakeFileMD5(filePath string) (string, error) {
...
func (sd *storageDriver) IsFileExist(path string) bool {
	_, err := os.Stat(path)
