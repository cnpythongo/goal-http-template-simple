...
type BaseModel struct {
	...
	CreateTime int64 `gorm:"column:create_time;autoCreateTime;not null;comment:数据创建时间" json:"-"`
	UpdateTime int64 `gorm:"column:update_time;autoUpdateTime;not null;comment:数据更新时间" json:"-"`
	DeleteTime int64 `gorm:"column:delete_time;default:0;comment:数据删除时间" json:"-"`
}
